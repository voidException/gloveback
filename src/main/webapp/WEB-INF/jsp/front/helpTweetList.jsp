...
<head>
    ...
    <link rel="stylesheet" href="<%=contextPath%>/resources/css/helpTweetList.css">
        ...
        <div  v-on:click="goTimeline" style="cursor:pointer ;">
            ...
            <div class="userHelpMain">
                ...
                <div class="imageArray">
                    <img :src="item.tweetbackupone" style="width: 90px;height: 70px;">
                    <img :src="item.tweetbackuptwo" style="width: 90px;height: 70px;">
                    <img :src="item.tweetbackupthree" style="width: 90px;height: 70px;">
                </div>
                <div class="cityFrom">
                    <div>来自：</div>
...
<script type="text/javascript" src="<%=contextPath%>/resources/javaScript/helpTweetList.js"></script>
</html>
