...
<head>
    ...
    <%--<script type="text/javascript" src="<%=contextPath%>/resources/javaScript/index.js"></script>--%>
    <%--<script type="text/javascript" src="<%=contextPath%>/resources/javaScript/test.js"></script>--%>
</head>
...
<div class="photo">
    <div class="photoLeft">
        ...
        <div style="float: left;font-size: 14px; height:34px;line-height: 34px;padding-top: 10px;padding-left: 10px;">赵燕芳</div>
    </div>
    <div class="photoRight">
        <div style="float: right;font-size:12px;color:#AAA;height:34px;line-height: 34px;padding-top: 10px;padding-right: 10px;">
            共计<span style="font-size:12px;color:red">7</span>天
        </div>
    </div>
</div>
...
<div style="margin-left: 10px;margin-right: 10px;">
    ...
    <div>
        <div style="margin-top: 10px;color: #AAA;float: left ">
            结束日期<span style="font-size: 13px;font-weight: bold;color:black">2017-10-10</span>
        </div>
...
<div  class="target" >
    <div class="targetMoneyWrapper">
        <div class="targetMoney"><strong>79471</strong><span class="targetMoneyAttr">元</span></div>
        <div class="targetDesp"> 目标金额</div>
    </div>
    <div style="height: 24px;border-right: #AAA solid 0.5px;"></div>
    <div class="targetMoneyWrapper" >
        <div class="targetMoney"><strong>1000</strong><span class="targetMoneyAttr">元</span></div>
        <div class="targetDesp"> 已筹钱数</div>
    </div>
    <div style="height: 24px;border-right: #AAA solid 0.5px;"></div>
    <div class="targetMoneyWrapper">
        <div class="targetMoney"><strong>100</strong><span class="targetMoneyAttr">次</span></div>
...
<div style="padding-left: 10px;padding-right:10px;margin-top: 10px;overflow: visible; max-height: none;font-size: 16px;word-wrap:break-word;line-height:1.7">
    ...
    你们好！
    泣血跪求各位能施援手，共救我哥哥的命。
    我20岁叫赵艳芳。我哥叫赵家胜。我是她的妹妹。他今年22岁。于2017年1月8日上午发生车祸，他为了闪避车导致的。现在伤的非常严重。 身上多处骨折，肋骨也断了，脑部受到严重的脑震荡，有出血，水肿的现象，现在没有什么意识。肺部也受到很大的创伤，现在感染的很厉害，只能靠吸氧机呼吸。
    我家是单亲家庭。
</div>
...
<div style="display: flex;flex-direction: row;justify-content: flex-start;flex-wrap: wrap">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/1.jpg">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/2.jpg">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/25.jpg">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/4.jpg">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/5.jpg">
    <img style="height: 96px;width: 23%;padding: 2px" src="<%=contextPath%>/resources/image/6.jpeg">
</div>
<div style="padding-left: 10px;padding-right: 10px; border-bottom:1px solid rgba(0,0,0,.15);border-top:1px solid rgba(0,0,0,.15);">
    ...
    <div style="margin-top: 14px">
        ...
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
            ...
            <div style="color: #2FAC4C;font-size: 13px;margin-top: 3px;margin-left: 2px">北京大学爱心社</div>
        </div>
    </div>
    <div style="margin-top: 14px">
        ...
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
            <img style="width: 12px;height: 12px" src="<%=contextPath%>/resources/image/selected.png">
            <div style="color: #2FAC4C;font-size: 13px;margin-top: 3px;margin-left: 2px">北京大学爱心社监督小组</div>
        </div>
    </div>
    <div style="margin-top: 14px;">
        ...
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
            <img style="width: 12px;height: 12px" src="<%=contextPath%>/resources/image/selected.png">
            <div style="color: #2FAC4C;font-size: 13px;margin-top: 3px;margin-left: 2px">北京大学艾海涛</div>
        </div>
    </div>
    <div style="margin-top: 14px;">
        ...
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;">
            <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
                <img style="width: 12px;height: 12px" src="<%=contextPath%>/resources/image/selected.png">
                <div style="color: #2FAC4C;font-size: 13px;margin-top: 3px;margin-left: 2px">王二五</div>
            </div>
    ...
    <div style="margin-top: 14px;">
        ...
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
            <img style="width: 12px;height: 12px" src="<%=contextPath%>/resources/image/selected.png">
            <div style="color: #2FAC4C;font-size: 13px;margin-top: 3px;margin-left: 2px">王三</div>
        </div>
        <div style="display: flex;flex-direction: row;align-items: center;justify-content: flex-start;padding-top: 6px">
            <img style="width: 12px;height: 12px" src="<%=contextPath%>/resources/image/selected.png">
    ...
    <div style="display: flex;justify-content: space-between;align-items: center;height: 46px;border-bottom:1px solid rgba(0,0,0,.15);">
        <div>有<span>66</span>人实名为Ta证实</div>
        <a href="#">我也来证实</a>
    </div>
    <div style="display: flex;align-items:center;justify-content: space-between;height: 60px">
        <div style="display: flex;justify-content: flex-start">
            <img style=" width: 38px;height: 38px;border-radius: 19px; " src="<%=contextPath%>/resources/image/1.jpg">
            <img style=" width: 38px;height: 38px;border-radius: 19px; margin-left: 10px" src="<%=contextPath%>/resources/image/1.jpg">
            <img style=" width: 38px;height: 38px;border-radius: 19px; margin-left: 10px " src="<%=contextPath%>/resources/image/1.jpg">
            <img style=" width: 38px;height: 38px;border-radius: 19px; margin-left: 10px" src="<%=contextPath%>/resources/image/1.jpg">
        </div>
        <div>
...
<div id="update">
    <template v-for="item in data">
        <div style="border-bottom: 1px solid rgba(0,0,0,.15);margin-top: 2px">
            <div style="display: flex;justify-content: space-between;align-items: flex-end;padding: 10px;">
                <div style="display: flex">
                    <img :src="item.user.avatar" style="height: 36px;width: 36px;border-radius: 18px">
                    <div style="margin-left: 10px">
                        <div style="display: flex;align-items: flex-start">
                            <div>{{item.user.nickname}}</div>
                            <div style="margin-left: 10px">支持了</div>
                            <div style="margin-left: 10px">{{item.title[1].text}}</div>
                        </div>
                        <div style="margin-top: 5px">{{item.created}}</div>
                    </div>
                </div>
                ...
                <template v-for="comment in item.comments">
                    <div style="display: flex;background: #F5F5F5;padding-top: 5px;padding-bottom: 5px;margin-right: 10px;margin-left: 20px">
                        <div  style="color: #4284B6;">
                            <span  v-bind:data-reciver="comment.sender.uuid"  v-on:click="test" style="cursor: pointer;">{{comment.sender.nickname}}</span><span>:</span>
                            <span v-if="comment.refer==true " >
                                <span style="color: #0f0f0f">回复</span><span  v-bind:data-reciver="comment.sender.uuid" v-on:click="test"  style="color: #4284B6;cursor: pointer;">{{comment.reciver.nickname}}</span><span>:</span>
                            </span>
                            <span style="color: #666">{{comment.content}}</span>
                        </div>
                        <!--<a v-if="comment.refer==true " >-->
                        <!--<span>回复</span><span style="color: #4284B6;cursor: pointer;">{{comment.reciver.nickname}}</span><span>:</span>-->
                        <!--</a>-->
